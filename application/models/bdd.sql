...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-04-2017 a las 03:40:34
...
(28, 'Ley de Dalton.docx', 'docx', '704239a30e0646da710a927b3dd7daf9.docx', '2017-04-18 20:02:46');
...
--
-- Volcado de datos para la tabla `files_knowledge`
--

INSERT INTO `files_knowledge` (`id_knowledge`, `id_file`) VALUES
(21, 28);
...
(5504, 'luisivanmorett@hotmail.com', '15e2b0d3c33891ebb0f1ef609ec419420c20e320ce94c65fbc8c3312448eb225', '123', '123', '123123', '123123', '12', '123123', '123123', 17, ''),
...
--
ALTER TABLE `estados`
  MODIFY `id_estado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
...
--
ALTER TABLE `tickets`
  MODIFY `id_ticket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT de la tabla `ticket_sus`
--
ALTER TABLE `ticket_sus`
  MODIFY `id_ticketSU` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
